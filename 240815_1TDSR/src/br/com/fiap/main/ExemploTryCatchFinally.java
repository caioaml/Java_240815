...
public class ExemploTryCatchFinally {
    public static void main(String[] args) {
        try {
            String aux1 = JOptionPane.showInputDialog("Forneça o valor do primeiro número. Faixa permitida de 1 à 50.");
            ...
            JOptionPane.showInputDialog(null, "Erro de divisão!\n" + e.getMessage(), "ERRO", JOptionPane.ERROR_MESSAGE);
        }catch (Exception e) {
            JOptionPane.showInputDialog(null, "Erro: " + e.getMessage(), "ERRO", JOptionPane.ERROR_MESSAGE);
        } finally {
